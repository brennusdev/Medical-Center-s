...
| GET | /api/v1/dashboard/doctor/{doctor_id} | Dashboard do m�dico |
| GET | /api/v1/dashboard/hospital/{hospital_id} | Dashboard operacional do hospital |
| GET | /api/v1/dashboard/admin | Dashboard de gest�o |
| GET | /api/v1/analytics/overview | Volumes gerais |
| GET | /api/v1/analytics/specialties | Solicita��es por especialidade |
| GET | /api/v1/analytics/hospitals | Filas por hospital |
| GET | /api/v1/analytics/wait-times | Tempo m�dio de espera (horas) |
| GET | /api/v1/analytics/priorities | Distribui��o de prioridades |
